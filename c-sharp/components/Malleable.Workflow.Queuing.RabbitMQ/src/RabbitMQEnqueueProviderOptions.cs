...
public class RabbitMQEnqueueProviderOptions : EnqueueProviderOptions
{
    public RabbitMQEnqueueProviderOptions(string? exchangeKey = null, string? queueName = null, string? routingKey = null, string? connectionString = null, string? hostName = null, int? port = null, string? exchangeType = null)
