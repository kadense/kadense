...
{
    public class V1Container : KadenseTemplatedCopiedResource<k8s.Models.V1Container>
    {
        ...
        public override k8s.Models.V1Container ToOriginal(Dictionary<string, string> variables)
        {
            return new k8s.Models.V1Container(
